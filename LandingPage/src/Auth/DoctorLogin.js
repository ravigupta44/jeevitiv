...
const DoctorLogin = ({setLoginUser }) => {
  ...
  const login = () => {
    axios
      .post(encodeURI("https://jeevitiv.herokuapp.com"+":" + "/doctorSignupPage/login/doctor/email"), user)
      .then((res) => {
    ...
    <Card className="login-body p-2 p-md-4">
      <Card.Body>
        <div className="loginHeading">
          <p className="loginFirstHeading">DoctorLogin</p>
